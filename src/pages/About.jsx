  ...
  return (
    <section className="max-container">
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>
            I've had the privilege of collaborating with a diverse
            array of companies, each experience a stepping stone
            toward refining my skills and partnering with brilliant minds.
